package com.niti.fotobesa.lib.views;
...
import com.niti.fotobesa.lib.adapters.CircularLoopAdapter;
import com.niti.fotobesa.lib.helpers.FotoBesaAutoScrollHelper;
import com.niti.fotobesa.lib.provider.ScrollConfigOptions;
 ...
 */
public class FotoBesaLayout extends LinearLayout implements View.OnTouchListener, ObservableListView.ListViewObserverDelegate {

    private static final String TAG = FotoBesaLayout.class.getSimpleName();
    ...
    private FotoBesaAutoScrollHelper mScrollHelper;
    ...
    public FotoBesaLayout(Context context) {
        super(context);
        init(context);
    }

    public FotoBesaLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.fotobesa, this, true);
    ...
    private void setScrollHelpers() {
        mScrollHelper = new FotoBesaAutoScrollHelper(mListViewLeft) {
            @Override
    ...
    public FotoBesaLayout setGap(int value) {
        mGap = value;
        setGap();
        return this;
    }

    public FotoBesaLayout setSpeed(int value) {
        mSpeed = value;
        calibrateSpeed();
        return this;
    }

    public FotoBesaLayout setDividerHeight(int value) {
        mDividerHeight = value;
        setDividerAndHeight(mDivider, value);
        return this;
    }

    public FotoBesaLayout setDivider(Drawable drawable) {
        mDivider = drawable;
    ...
    public FotoBesaLayout setGapColor(int color) {
        mGapColor = color;
        setGap();
        return this;
    }

    public FotoBesaLayout setAutoScrollFaster(int option) {
        isAutoScrollLeftListFaster = option == 1;
        calibrateSpeed();
        return this;
    }

    public FotoBesaLayout setManualScrollFaster(int option) {
